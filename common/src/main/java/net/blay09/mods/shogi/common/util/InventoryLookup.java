...
public class InventoryLookup {
    ...
    public static int countMatchingInPlayerInventory(Player player, Predicate<ItemStack> matcher) {
        return countMatchingInContainer(player.getInventory(), matcher);
    }

    public static int countMatchingInContainer(Container container, Predicate<ItemStack> matcher) {
        int count = 0;
    ...
    public static int consumeFromPlayerInventory(Player player, Predicate<ItemStack> matcher, int count) {
        return consumeFromContainer(player.getInventory(), matcher, count);
    }

    public static int consumeFromContainer(Container container, Predicate<ItemStack> matcher, int count) {
        if (count <= 0) {
            return 0;
        }

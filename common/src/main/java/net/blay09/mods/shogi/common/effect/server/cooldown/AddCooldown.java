...
public record AddCooldown(Identifier identifier, ShogiEffect<?> effect) implements ShogiEffect<Boolean> {
    ...
    public static MapCodec<AddCooldown> mapCodec(ShogiScope scope) {
        return RecordCodecBuilder.mapCodec(instance -> instance.group(
                ...
                EffectArgumentCodecs.effectOrConstant(scope).fieldOf("duration").forGetter(AddCooldown::effect)
    ...
    public Either<Boolean, Object> apply(ShogiContext context) {
        ...
        final var durationTicks = effect.apply(context).mapLeft(Coercion.INT).orThrow();
